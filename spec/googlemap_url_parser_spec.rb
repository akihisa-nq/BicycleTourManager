...
describe GoogleMapUriParser do
	geocode_cache = "test_cache_geocode.db"
	route_cache = "test_cache_route.db"
	elevation_cache = "test_cache_elevation.db"
	...
	it "can analyze old format without cache" do
		...
		File.delete(geocode_cache) if File.exist?(geocode_cache)
